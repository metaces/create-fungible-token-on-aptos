...
module aptos_asset::fungible_asset{
    ...
    /// This function borrows the refs needed to manage the fungible asset.It's used to ensure that
    /// only the owner of the metadata object can access the refs.
    ...
    /// Withdraws a specified amount of fungible assets from the primary store of the given address.It
    /// uses the transfer reference to perform the withdrawal.
